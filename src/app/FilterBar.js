    ...
    <SectionWrapper>
      <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-3 w-full items-stretch">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap gap-4 flex-1">
          ...
          >
            {({ open }) => (
              <div className="relative w-full md:w-[175px] lg:w-[175px] text-[14px] font-normal cursor-pointer">
                <Listbox.Button className="flex items-center justify-between w-full border border-[#E3E3E3] bg-[#F1F1F1] text-[#1D0129] py-2 px-3 relative outline-none cursor-pointer">
                  ...
                  >
                    <ChevronDown className="w-6 h-6 text-[#1D0129] text-normal" />
                  </motion.div>{" "}
                </Listbox.Button>
                ...
                <AnimatePresence>
                  <Listbox.Options
                    ...
                    className="absolute z-50 max-h-60 min-w-[240px] w-full overflow-y-auto bg-white border-2 border-[#E3E3E3] py-1 text-[14px] focus:outline-none"
                  >
                    <p className="text-[14px] font-medium p-2">Region</p>
              ...
              <div className="relative w-full md:w-[175px] lg:w-[175px] text-[14px] font-normal cursor-pointer">
                ...
                <AnimatePresence>
                  <Listbox.Options
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    transition={{ duration: 0.2 }}
                    className="absolute z-10 max-h-60 min-w-[240px] w-full overflow-auto bg-white border-2 border-[#E3E3E3] py-1 text-[14px] focus:outline-none"
                  >
                    <p className="text-[14px] font-medium p-2">Labos</p>
...
/>                          
          ...
          >
            {({ open }) => (
              <div className="relative w-full md:w-[230px] lg:w-[230px] text-[14px] font-normal cursor-pointer">
                <Listbox.Button className="flex items-center justify-between w-full border border-[#E3E3E3] bg-[#F1F1F1] text-[#1D0129] py-2 px-3 relative outline-none cursor-pointer">
                  <div className="flex items-center space-x-2 flex-wrap gap-1">
                    <Structure
                      className="w-4 h-4"
