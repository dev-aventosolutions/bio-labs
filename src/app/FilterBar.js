  ...
  return (
    <SectionWrapper>
      <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-3 w-full items-stretch">
        {/* Filters Group - Modified for mobile layout */}
...
<ChevronDown className="hidden md:block w-6 h-6 text-[#1D0129] text-normal" />
  ...
  >
    {/* Show total number of unique regions in title */}
              ...
              {({ open }) => (
                <div className="relative w-1/2  md:w-[175px] lg:w-[175px] md:text-[14px] text-[10px] font-normal cursor-pointer">
                  <Listbox.Button className="flex items-center justify-between w-full border border-[#E3E3E3] bg-[#F1F1F1] text-[#1D0129] py-2 px-3 relative outline-none cursor-pointer">
                    <div className="flex items-center space-x-2 flex-wrap gap-1">
                      <Labos
                        className="w-[12.52px] h-[15px] text-gray-800 "
...
<ChevronDown className="hidden md:block w-6 h-6 text-[#1D0129] text-normal" />
  ...
  >
    {/* Show total number of unique labos in title */}
